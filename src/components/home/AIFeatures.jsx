...
const features = [
  {
    ...
    description:
      "Transform screenshots from 3DS Max, SketchUp, Revit, or any 3D software into stunning photorealistic renders instantly.",
    image: img1,
  },
  {
    id: 2,
    ...
    title: "AI Upscaling",
    description:
      "Industry-leading upscaling powered by Magnific Creative and Magnific Precision V2. Transform low-res images into ultra-sharp, professional quality.",
    image: img2,
  },
  {
    id: 3,
    ...
    title: "AI Animations",
    description:
      "Bring your renders to life with cutting-edge video engines: Veo, Kling, Seedance, and Sora. Create cinematic walkthroughs in seconds.",
    image: img3,
  },
  {
    id: 4,
    ...
    description:
      "Generate 3D models with Meshy AI and Tripo3D integration. Preview, refine, and export directly to your favorite 3D software.",
    image: img4,
  },
  {
    id: 5,
    ...
    description:
      "Paint exactly where you want changes. Our AI intelligently understands your intent and seamlessly modifies specific areas.",
    image: img5,
  },
  {
    id: 6,
    ...
    description:
      "Paste and position any image onto your canvas. Perfect for adding furniture, people, or decorative elements with natural blending.",
    image: img6,
  },
  {
    id: 7,
    ...
    description:
      "Combine multiple images to add specific objects, textures, or elements. Create complex scenes from simple components.",
    image: img7,
  },
  {
    id: 8,
    ...
    description:
      "Save your favorite prompts and styles. Build a library of tailored presets for consistent, brand-aligned results every time.",
    image: img8,
  },
  {
    id: 9,
    ...
    title: "Text-to-Image",
    description:
      "Create any image from scratch using the world's top AI engines. Describe your vision and watch it materialize in seconds.",
    image: img9,
  },
];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(0,255,255,0.05) 0%, rgba(3,6,18,1) 100%)",
        }}
      />
      ...
      >
        ...
        <div className="relative overflow-hidden h-40 mb-4 flex-shrink-0">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 50% 0%, rgba(0,255,255,0.14) 0%, transparent 70%)",
              opacity: hovered ? 1 : 0,
            }}
          />
        </div>
...
const AIFeatures = () => {
  return (
    <section className="py-20 px-6 flex justify-center flex-col items-center">
      {/* Header */}
      <div className="text-center w-[1200px] max-w-full mx-auto mb-10">
        <h2
