...
import HowItWorksModal from '../home/HowItWorksModal'
import DownloadvizMakermodal from '../home/DownloadvizMakermodal'
import DownloadvizMakerForMobilemodal from '../home/DownloadvizMakerForMobilemodal'

const navLinks = [
  { label: 'Home', sectionId: 'home' },
  { label: 'Plugins', sectionId: 'products' },
        ...
        >
          {navLinks.map(({ label, sectionId }) => (
            <button
              ...
              className={`flex-1 h-full rounded-full text-xs sm:text-sm font-medium transition-all duration-200 whitespace-nowrap ${active === label
            ...
            <div className="flex flex-col p-6 gap-4 z-50">
              ...
              {navLinks.map(({ label, sectionId }) => (
                <button
                  ...
                  className={`w-full py-3 px-4 rounded-lg text-left transition-all ${active === label
                    ? 'bg-white/10 text-white border border-white/20'
